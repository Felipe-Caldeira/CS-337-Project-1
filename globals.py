...
# Movie/show-type awards
MOVIE_AWARDS = ['best motion picture', 'film', 'score', 'song', 'score', 'best television', 'best mini']

# Person-type awards
PERSON_AWARDS = ['cecil', 'best performance', 'best director', 'best dressed']
